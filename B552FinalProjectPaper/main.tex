...
\begin{figure*}
    ...
    \includegraphics[scale= 0.5]{low_game_eval.jpg}
    \includegraphics[scale= 0.5]{low_game_time.jpg}
    \includegraphics[scale= 0.5]{mid_game_score.jpg}
    \includegraphics[scale= 0.5]{mid_game_time.jpg}
    \includegraphics[scale= 0.5]{high_game_eval.jpg}
    \includegraphics[scale= 0.5]{high_game_time.jpg}
  
    \caption{Comparison made between RulePlayer and }
  
    % \label{AAA}
  
    % \center
    % \includegraphics[scale=0.5]{high_game_eval}    
\end{figure*}
